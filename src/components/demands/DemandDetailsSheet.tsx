...
interface DemandDetailsSheetProps {
  demand: Demand | null;
  open: boolean;
...
const DemandDetailsSheet = ({ demand, open, onOpenChange, onUpdate }: DemandDetailsSheetProps) => {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-lg p-0 flex flex-col">
        <SheetHeader className="p-4 pb-0">
          <SheetTitle className="text-left line-clamp-2">{demand.title}</SheetTitle>
        </SheetHeader>
...
export default DemandDetailsSheet;

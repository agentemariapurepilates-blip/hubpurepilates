...
import { Search, FolderOpen, ChevronLeft } from 'lucide-react';
...
/**
 * Aba "Artes personalizadas" do Pure Design: galeria de modelos editáveis
 * (edite os textos no editor e baixe como PNG). Conteúdo puro, sem MainLayout —
 * a casca (header + abas) fica em PureDesign.tsx.
 */
const ArtesPersonalizadas = () => {
...
export default ArtesPersonalizadas;
